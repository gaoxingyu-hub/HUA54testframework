...
# Form implementation generated from reading ui file 'D:\code\54testframework\ui\security_machine\security.ui'
#
...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/newPrefix/icon/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/newPrefix/icon/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.treeWidget.topLevelItem(0).setText(0, _translate("Dialog", TransConstants.ip_protector))
