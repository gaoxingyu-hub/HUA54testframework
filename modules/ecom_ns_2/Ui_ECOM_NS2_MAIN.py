...
"")
        ...
        self.tableWidget_test_results_ecom_ns2 = QtWidgets.QTableWidget(self.tab)
        ...
        self.gridLayout_8.addWidget(self.tableWidget_test_results_ecom_ns2, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "ECOM_NS_2型交换机"))
