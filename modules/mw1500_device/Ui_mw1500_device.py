...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        if SystemLanguage.LANGUAGE == SystemLanguage.fr_FR:
                self.groupBox_test_modules.setTitle(_translate("Dialog", "Elément de test"))
                self.treeWidget.headerItem().setText(0, _translate("Dialog", "1"))
                __sortingEnabled = self.treeWidget.isSortingEnabled()
                self.treeWidget.setSortingEnabled(False)
                self.treeWidget.topLevelItem(0).setText(0, _translate("Dialog", "Équipement de communication micro-ondes MW-1500"))
                self.treeWidget.topLevelItem(0).child(0).setText(0, _translate("Dialog", "unité de réception et d’émission/l’émetteur"))
                self.treeWidget.topLevelItem(0).child(1).setText(0, _translate("Dialog", "unité de réception et d’émission/l’émetteur"))
                self.treeWidget.topLevelItem(0).child(2).setText(0, _translate("Dialog", "Amplificateur à bas bruit"))
                self.treeWidget.topLevelItem(0).child(3).setText(0, _translate("Dialog", "coupleur"))
                self.treeWidget.topLevelItem(0).child(4).setText(0, _translate("Dialog", "circulateur de signal"))
                self.treeWidget.topLevelItem(0).child(5).setText(0, _translate("Dialog", "filtre d’onde"))
                self.treeWidget.topLevelItem(0).child(6).setText(0, _translate("Dialog", "interrupteur de guide d’onde"))
                self.treeWidget.topLevelItem(0).child(7).setText(0, _translate("Dialog", "module de surveillance"))
                ...
                item.setText(_translate("Dialog", "Elément de test"))
                item = self.tableWidget_test_results_tr_t.horizontalHeaderItem(2)
                item.setText(_translate("Dialog", "Condition de test"))
                item = self.tableWidget_test_results_tr_t.horizontalHeaderItem(3)
                item.setText(_translate("Dialog", "Conclusion de test"))
                item = self.tableWidget_test_results_tr_t.horizontalHeaderItem(4)
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "unité de réception et d’émission/l’émetteur"))
                ...
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _translate("Dialog", "unité de réception et d’émission/l’émetteur"))
                ...
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Dialog", "amplificateur de bas bruit"))
                ...
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Dialog", "amplificateur de puissance"))
                ...
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("Dialog", "circulateur de signal"))
                ...
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("Dialog", "interrupteur de guide d’onde"))
                ...
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("Dialog", "coupleur"))
                ...
                item.setText(_translate("Dialog", "Conclusion d 'essai"))
                self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("Dialog", "module de surveillance"))
        else:
