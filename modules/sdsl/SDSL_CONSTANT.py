...
class ModuleConstants:
    if SystemLanguage.LANGUAGE == SystemLanguage.fr_FR:
        ...
        QMESSAGEBOX_WARN_COM_CONNECT_FAIL = "Serial connection failure"
        QMESSAGEBOX_CONTENTS_TEST_FINISH = "Achèvement de test"
        WINDOW_TITLE_MAIN = "Test de commutateur de type ecom_ns_2"
        ...
        QMESSAGEBOX_WARN_COM_CONNECT_FAIL = "串口连接失败"
        QMESSAGEBOX_CONTENTS_TEST_FINISH = "测试完成"
        WINDOW_TITLE_MAIN = "ECOM_NS_2交换机测试"
        PROCESS_CONTROL_NEXT = "next"
        PROCESS_CONTROL_FINISH = "finish"
        CONTENTS_NEXT = "下一步"
        CONTENTS_NOT = "不"
