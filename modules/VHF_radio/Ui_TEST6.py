...
"background-color:#E3EAF4;}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_1.setText(_translate("Dialog", "la fréquence est"))
        self.comboBox_1.setItemText(0, _translate("Dialog", "MHz"))
        self.label_2.setText(_translate("Dialog", "le mode de modulation"))
        self.comboBox_2.setItemText(0, _translate("Dialog", "FM"))
        self.comboBox_2.setItemText(1, _translate("Dialog", "AM"))
        self.label_3.setText(_translate("Dialog", "le signal de modulation est"))
        self.comboBox_3.setItemText(0, _translate("Dialog", "kHz"))
        self.label_5.setText(_translate("Dialog", "et l'amplitude du signal est"))
        self.comboBox_5.setItemText(0, _translate("Dialog", "dBm"))
        self.label_4.setText(_translate("Dialog", " l'écart de fréquence est"))
