...
class DialogTest17(QDialog, Ui_Dialog):
    ...
    def on_pushButton_next_clicked(self):
        ...
        if 55 - 500 < mTemp[0] < 55 + 500 and 36 < mTemp[1] < 38:
            DialogTest17.flag=1
            self.test_result.test_item = "测量电台中功率发55MHz功能"
            ...
            QMessageBox.information(self, "提示", "测量电台中功率发55MHz功能合格", QMessageBox.Ok)
            ...
            QMessageBox.information(self, "提示", "测量电台中功率发55MHz功能不合格", QMessageBox.Ok)
            self.signalTest.emit('test')
