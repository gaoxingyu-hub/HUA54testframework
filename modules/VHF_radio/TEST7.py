...
class DialogTest7(QDialog, Ui_Dialog):
    ...
    def on_pushButton_1_clicked(self):
        ...
        self.test_result.test_results = ModuleConstants.shoubing_yes
        self.test_result.test_conclusion = 'PASS'
        QMessageBox.information(self, ModuleConstants.tip, ModuleConstants.shoubing_yes, QMessageBox.Ok)
