...
class AUTO_TEST_LNA(QDialog, Ui_Dialog):
    """
    ...
    def initUi(self,mConfig):
        ...
        freq_sg= mConfig.test_case_detail[1]["test_para"][0]
        power_sg= mConfig.test_case_detail[1]["test_para"][1]
        freq_sa= mConfig.test_case_detail[1]["test_para"][2]
        bw_sa= mConfig.test_case_detail[1]["test_para"][3]
    ...
    def on_pushButton_next_clicked(self):
        ...
        if not self.demo:
            try:
                ...
                print('仪表连接错误，请确认！')
                return
        self.test_result.test_item = ModuleConstants.TESTITEM_LNA
        ...
        if self.thresholdL<self.test_result.test_results <self.thresholdH:
            ...
            QMessageBox.information(self,ModuleConstants.QMESSAGEBOX_INFO,ModuleConstants.TESTITEM_LNA+
