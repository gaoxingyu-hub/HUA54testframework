...
def initialize(log=True, log_level=logging.INFO, log_handle=LogHandle.LOG_CONSOLE, host='127.0.0.1', port=9001, timeout=30000):
    """
    ...
    try:
        # if log:
        init_log(logging.INFO, LogHandle.LOG_FILE)
        ...
        # connect to cl
        RenixApiManager.connection_init('127.0.0.1', 9001, 30000)
