...
@rom_manager.rom
class RipPortRateConfig(ROMObject):
    def __init__(self, UpdateRoutesTransmitRate=None, **kwargs):
        self._UpdateRoutesTransmitRate = UpdateRoutesTransmitRate  # RIP Tx Rate (messages/sec) 
        ...
        super(RipPortRateConfig, self).__init__(**properties)
    ...
    def edit(self, UpdateRoutesTransmitRate=None, **kwargs):
        ...
        super(RipPortRateConfig, self).edit(**properties)
