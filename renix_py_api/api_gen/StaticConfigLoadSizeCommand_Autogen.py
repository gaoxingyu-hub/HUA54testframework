...
@rom_manager.rom
class StaticConfigLoadSizeCommand(ROMCommand):
    def __init__(self, LoadMode=None, LoadUnit=None, FixedLoad=None, LoadStart=None, LoadStep=None, LoadEnd=None, RandomMinLoad=None, RandomMaxLoad=None, CustomLoadList=None, **kwargs):
        ...
        super(StaticConfigLoadSizeCommand, self).__init__(**properties)
    ...
    def _set_loadmode_with_str(self, value):
        seperate = value.find(':')
        exec('self._LoadMode = EnumAsymmetricLoadMode.%s' % value[:seperate])
