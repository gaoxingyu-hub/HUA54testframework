...
@rom_manager.rom
class BroadcastFrameForwardingConfig(ForwardingConfig):
    def __init__(self, DiagramMode=None, **kwargs):
        ...
        super(BroadcastFrameForwardingConfig, self).__init__(**properties)
    ...
    def edit(self, DiagramMode=None, **kwargs):
        ...
        super(BroadcastFrameForwardingConfig, self).edit(**properties)
