...
@rom_manager.rom
class DynamicBoolAttribute(DynamicAttribute):
    def __init__(self, AttributeValue=None, **kwargs):
        ...
        super(DynamicBoolAttribute, self).__init__(**properties)
    ...
    def edit(self, AttributeValue=None, **kwargs):
        ...
        super(DynamicBoolAttribute, self).edit(**properties)
    ...
    def _set_attributevalue_with_str(self, value):
        self._AttributeValue = (value == 'True')
