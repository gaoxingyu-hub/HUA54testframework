...
@rom_manager.rom
class Vlan3Parameter(ROMObject):
    def __init__(self, VlanId=None, Priority=None, IsBound=None, **kwargs):
        self._VlanId = VlanId  # VLAN 3
        self._Priority = Priority  # VLAN 3 Priority
        ...
        super(Vlan3Parameter, self).__init__(**properties)
    ...
    def edit(self, VlanId=None, Priority=None, IsBound=None, **kwargs):
        ...
        super(Vlan3Parameter, self).edit(**properties)
