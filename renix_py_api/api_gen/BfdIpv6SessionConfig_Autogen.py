...
@rom_manager.rom
class BfdIpv6SessionConfig(ROMObject):
    def __init__(self, NumberOfSessions=None, StartDestinationAddress=None, DestinationAddressIncrement=None, EnableMyDiscriminator=None, MyDiscriminator=None, MyDiscriminatorIncrement=None, **kwargs):
        self._SourceAddressGlobal = '::'  # Source Address (Global), not editable
        self._SourceAddressLinkLocal = '::'  # Source Address (Link Local), not editable
        ...
        self._EndDestinationAddress = '2000::1'  # End Destination Address, not editable
        ...
        super(BfdIpv6SessionConfig, self).__init__(**properties)
    ...
    def edit(self, NumberOfSessions=None, StartDestinationAddress=None, DestinationAddressIncrement=None, EnableMyDiscriminator=None, MyDiscriminator=None, MyDiscriminatorIncrement=None, **kwargs):
        ...
        super(BfdIpv6SessionConfig, self).edit(**properties)

    @property
    def SourceAddressGlobal(self):
        """
        get the value of property _SourceAddressGlobal
        """
        if self.force_auto_sync:
            self.get('SourceAddressGlobal')
        return self._SourceAddressGlobal

    @property
    def SourceAddressLinkLocal(self):
        """
        get the value of property _SourceAddressLinkLocal
        """
        if self.force_auto_sync:
            self.get('SourceAddressLinkLocal')
        return self._SourceAddressLinkLocal
    ...
    def _set_sourceaddressglobal_with_str(self, value):
        self._SourceAddressGlobal = value

    def _set_sourceaddresslinklocal_with_str(self, value):
        self._SourceAddressLinkLocal = value
