...
@rom_manager.rom
class Ospfv3IntraAreaPrefixLsaConfig(ROMObject):
    def __init__(self, AdvertisingRouterId=None, LinkStateId=None, ReferencedLsType=None, ReferencedAdvertisingRouterId=None, ReferencedLinkStateId=None, PrefixCount=None, StartPrefixAddress=None, PrefixLength=None, Increment=None, PrefixOptions=None, Metric=None, Age=None, SequenceNumber=None, Checksum=None, **kwargs):
        ...
        self._ReferencedAdvertisingRouterId = ReferencedAdvertisingRouterId  # Referenced Advertising Router ID
        ...
        if ReferencedAdvertisingRouterId is not None:
            properties['ReferencedAdvertisingRouterId'] = ReferencedAdvertisingRouterId
        ...
        super(Ospfv3IntraAreaPrefixLsaConfig, self).__init__(**properties)
    ...
    def edit(self, AdvertisingRouterId=None, LinkStateId=None, ReferencedLsType=None, ReferencedAdvertisingRouterId=None, ReferencedLinkStateId=None, PrefixCount=None, StartPrefixAddress=None, PrefixLength=None, Increment=None, PrefixOptions=None, Metric=None, Age=None, SequenceNumber=None, Checksum=None, **kwargs):
        properties = kwargs.copy()
        if AdvertisingRouterId is not None:
        ...
        if ReferencedLsType is not None:
            ...
            properties['ReferencedLsType'] = ReferencedLsType
        if ReferencedAdvertisingRouterId is not None:
            self._ReferencedAdvertisingRouterId = ReferencedAdvertisingRouterId
            properties['ReferencedAdvertisingRouterId'] = ReferencedAdvertisingRouterId
        if ReferencedLinkStateId is not None:
        ...
        super(Ospfv3IntraAreaPrefixLsaConfig, self).edit(**properties)
    ...
    @property
    def ReferencedAdvertisingRouterId(self):
        """
        get the value of property _ReferencedAdvertisingRouterId
        """
        if self.force_auto_sync:
            self.get('ReferencedAdvertisingRouterId')
        return self._ReferencedAdvertisingRouterId
    ...
    @ReferencedAdvertisingRouterId.setter
    def ReferencedAdvertisingRouterId(self, value):
        self._ReferencedAdvertisingRouterId = value
        self.edit(ReferencedAdvertisingRouterId=value)
    ...
    def _set_referencedadvertisingrouterid_with_str(self, value):
        self._ReferencedAdvertisingRouterId = value
