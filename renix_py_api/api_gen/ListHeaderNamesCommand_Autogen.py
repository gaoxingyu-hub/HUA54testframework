...
@rom_manager.rom
class ListHeaderNamesCommand(ROMCommand):
    def __init__(self, Stream=None, Index=None, **kwargs):
        self._Stream = Stream  # Stream Handle
        self._Index = Index  # Header Index
        ...
        super(ListHeaderNamesCommand, self).__init__(**properties)
