...
@rom_manager.rom
class IsisBfdSessionResult(Result):
    def __init__(self, **kwargs):
        self._IpSessionKeyID = 0  # Ipv4 Session Key ID, not editable
        self._IpSessionID = ''  # IS-IS Session Name, not editable
        ...
        super(IsisBfdSessionResult, self).__init__(**properties)
    ...
    @property
    def IpSessionKeyID(self):
        """
        get the value of property _IpSessionKeyID
        """
        if self.force_auto_sync:
            self.get('IpSessionKeyID')
        return self._IpSessionKeyID

    @property
    def IpSessionID(self):
        """
        get the value of property _IpSessionID
        """
        if self.force_auto_sync:
            self.get('IpSessionID')
        return self._IpSessionID
    ...
    def _set_ipsessionkeyid_with_str(self, value):
        try:
            self._IpSessionKeyID = int(value)
        except ValueError:
            self._IpSessionKeyID = hex(int(value, 16))

    def _set_ipsessionid_with_str(self, value):
        self._IpSessionID = value
