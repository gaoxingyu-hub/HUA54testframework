...
@rom_manager.rom
class Ospfv3WizardConfig(ProtocolWizardConfig):
    def __init__(self, AreaId=None, AreaIdStep=None, EnableAreaIdStepByPort=None, AreaIdStepByPort=None, NetworkType=None, Priority=None, Options=None, EnableGracefulRestart=None, GracefulRestartReason=None, EnableBfd=None, **kwargs):
        ...
        super(Ospfv3WizardConfig, self).__init__(**properties)
    ...
    def edit(self, AreaId=None, AreaIdStep=None, EnableAreaIdStepByPort=None, AreaIdStepByPort=None, NetworkType=None, Priority=None, Options=None, EnableGracefulRestart=None, GracefulRestartReason=None, EnableBfd=None, **kwargs):
        properties = kwargs.copy()
        if AreaId is not None:
            self._AreaId = AreaId
            properties['AreaId'] = AreaId
        ...
        super(Ospfv3WizardConfig, self).edit(**properties)
