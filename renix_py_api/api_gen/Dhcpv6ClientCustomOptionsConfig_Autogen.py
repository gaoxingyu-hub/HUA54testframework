...
@rom_manager.rom
class Dhcpv6ClientCustomOptionsConfig(ROMObject):
    def __init__(self, OptionVal=None, IncludeMsg=None, Wildcards=None, StringIsHexadecimal=None, OptionPayload=None, OptionHexPayload=None, RemoveOption=None, **kwargs):
        self._OptionVal = OptionVal  # Option Value
        self._IncludeMsg = swap_int_to_enum_flag(IncludeMsg, EnumDhcpv6IncludeMsg)  # Include in Message
        ...
        self._RemoveOption = RemoveOption  # Remove Option
        ...
        if RemoveOption is not None:
            properties['RemoveOption'] = RemoveOption

        # call base class function, and it will send message to renix server to create a class.
        super(Dhcpv6ClientCustomOptionsConfig, self).__init__(**properties)
    ...
    def edit(self, OptionVal=None, IncludeMsg=None, Wildcards=None, StringIsHexadecimal=None, OptionPayload=None, OptionHexPayload=None, RemoveOption=None, **kwargs):
        properties = kwargs.copy()
        if OptionVal is not None:
            self._OptionVal = OptionVal
            properties['OptionVal'] = OptionVal
        if IncludeMsg is not None:
            self._IncludeMsg = swap_int_to_enum_flag(IncludeMsg, EnumDhcpv6IncludeMsg)
            if isinstance(IncludeMsg, Flag):
                properties['IncludeMsg'] = IncludeMsg.value
            else:
                properties['IncludeMsg'] = IncludeMsg
        ...
        if OptionHexPayload is not None:
            ...
            properties['OptionHexPayload'] = OptionHexPayload
        if RemoveOption is not None:
            self._RemoveOption = RemoveOption
            properties['RemoveOption'] = RemoveOption

        super(Dhcpv6ClientCustomOptionsConfig, self).edit(**properties)
    ...
    def RemoveOption(self):
        """
        get the value of property _RemoveOption
        """
        if self.force_auto_sync:
            self.get('RemoveOption')
        return self._RemoveOption
    ...
    def IncludeMsg(self, value):
        self._IncludeMsg = swap_int_to_enum_flag(value, EnumDhcpv6IncludeMsg)
    ...
    def RemoveOption(self, value):
        self._RemoveOption = value
        self.edit(RemoveOption=value)
    ...
    def _set_includemsg_with_str(self, value):
        seperate = value.find(':')
        self._IncludeMsg = swap_int_to_enum_flag(int(value[seperate+1:]), EnumDhcpv6IncludeMsg)
    ...
    def _set_removeoption_with_str(self, value):
        self._RemoveOption = (value == 'True')
