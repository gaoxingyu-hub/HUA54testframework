...
@rom_manager.rom
class Ospfv2PortConfig(ROMObject):
    def __init__(self, TransmitRate=None, UpdateMsgTransmitRate=None, EnableLoop=None, **kwargs):
        self._TransmitRate = TransmitRate  # OSPFv2 Message Tx Rate (messages/second)
        self._UpdateMsgTransmitRate = UpdateMsgTransmitRate  # OSPFv2 Update Message Tx Rate (messages/second)
        ...
        super(Ospfv2PortConfig, self).__init__(**properties)
    ...
    def edit(self, TransmitRate=None, UpdateMsgTransmitRate=None, EnableLoop=None, **kwargs):
        ...
        super(Ospfv2PortConfig, self).edit(**properties)
