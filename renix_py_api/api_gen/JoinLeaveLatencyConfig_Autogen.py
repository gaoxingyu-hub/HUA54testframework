...
@rom_manager.rom
class JoinLeaveLatencyConfig(Rfc3918Config):
    def __init__(self, TrafficStartAndJoinInterval=None, LeaveAndTrafficStopInterval=None, TrafficLoadUnit=None, TrafficLoadMode=None, TrafficLoad=None, RandomMinLoad=None, RandomMaxLoad=None, TrafficLoadStart=None, TrafficLoadStep=None, TrafficLoadEnd=None, TrafficLoadCustom=None, McGroupCount=None, McGroupCountMode=None, RandomMinMcGroupCount=None, RandomMaxMcGroupCount=None, McGroupCountStart=None, McGroupCountStep=None, McGroupCountEnd=None, McGroupCountCustom=None, **kwargs):
        self._TrafficStartAndJoinInterval = TrafficStartAndJoinInterval  # Interval between starting traffic and sending Joins(sec)
        self._LeaveAndTrafficStopInterval = LeaveAndTrafficStopInterval  # Interval between sending Joins and sending Leaves(sec)
        ...
        if TrafficStartAndJoinInterval is not None:
            properties['TrafficStartAndJoinInterval'] = TrafficStartAndJoinInterval
        if LeaveAndTrafficStopInterval is not None:
            properties['LeaveAndTrafficStopInterval'] = LeaveAndTrafficStopInterval
        ...
        super(JoinLeaveLatencyConfig, self).__init__(**properties)
    ...
    def edit(self, TrafficStartAndJoinInterval=None, LeaveAndTrafficStopInterval=None, TrafficLoadUnit=None, TrafficLoadMode=None, TrafficLoad=None, RandomMinLoad=None, RandomMaxLoad=None, TrafficLoadStart=None, TrafficLoadStep=None, TrafficLoadEnd=None, TrafficLoadCustom=None, McGroupCount=None, McGroupCountMode=None, RandomMinMcGroupCount=None, RandomMaxMcGroupCount=None, McGroupCountStart=None, McGroupCountStep=None, McGroupCountEnd=None, McGroupCountCustom=None, **kwargs):
        properties = kwargs.copy()
        if TrafficStartAndJoinInterval is not None:
            self._TrafficStartAndJoinInterval = TrafficStartAndJoinInterval
            properties['TrafficStartAndJoinInterval'] = TrafficStartAndJoinInterval
        if LeaveAndTrafficStopInterval is not None:
            self._LeaveAndTrafficStopInterval = LeaveAndTrafficStopInterval
            properties['LeaveAndTrafficStopInterval'] = LeaveAndTrafficStopInterval
        if TrafficLoadUnit is not None:
        ...
        super(JoinLeaveLatencyConfig, self).edit(**properties)

    @property
    def TrafficStartAndJoinInterval(self):
        """
        get the value of property _TrafficStartAndJoinInterval
        """
        if self.force_auto_sync:
            self.get('TrafficStartAndJoinInterval')
        return self._TrafficStartAndJoinInterval

    @property
    def LeaveAndTrafficStopInterval(self):
        """
        get the value of property _LeaveAndTrafficStopInterval
        """
        if self.force_auto_sync:
            self.get('LeaveAndTrafficStopInterval')
        return self._LeaveAndTrafficStopInterval
    ...
    @TrafficStartAndJoinInterval.setter
    def TrafficStartAndJoinInterval(self, value):
        self._TrafficStartAndJoinInterval = value
        self.edit(TrafficStartAndJoinInterval=value)

    @LeaveAndTrafficStopInterval.setter
    def LeaveAndTrafficStopInterval(self, value):
        self._LeaveAndTrafficStopInterval = value
        self.edit(LeaveAndTrafficStopInterval=value)
    ...
    def _set_trafficstartandjoininterval_with_str(self, value):
        try:
            self._TrafficStartAndJoinInterval = int(value)
        except ValueError:
            self._TrafficStartAndJoinInterval = hex(int(value, 16))

    def _set_leaveandtrafficstopinterval_with_str(self, value):
        try:
            self._LeaveAndTrafficStopInterval = int(value)
        except ValueError:
            self._LeaveAndTrafficStopInterval = hex(int(value, 16))
