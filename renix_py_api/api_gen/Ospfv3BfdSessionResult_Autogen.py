...
@rom_manager.rom
class Ospfv3BfdSessionResult(Result):
    def __init__(self, **kwargs):
        self._Ipv6SessionKeyID = 0  # Ipv6 Session Key ID, not editable
        self._Ipv6SessionID = ''  # OSPFv3 Session Name, not editable
        self._SessionID = ''  # BFD Session Name, not editable
        self._SessionIndex = 0  # BFD Session Index, not editable
        self._Ipv6SourceAddress = '::0'  # IPv6 Source Address, not editable
        self._Ipv6DestinationAddress = '::0'  # IPv6 Destination Address, not editable
        ...
        super(Ospfv3BfdSessionResult, self).__init__(**properties)
    ...
    @property
    def Ipv6SessionKeyID(self):
        """
        get the value of property _Ipv6SessionKeyID
        """
        if self.force_auto_sync:
            self.get('Ipv6SessionKeyID')
        return self._Ipv6SessionKeyID

    @property
    def Ipv6SessionID(self):
        """
        get the value of property _Ipv6SessionID
        """
        if self.force_auto_sync:
            self.get('Ipv6SessionID')
        return self._Ipv6SessionID
    ...
    def _set_ipv6sessionkeyid_with_str(self, value):
        try:
            self._Ipv6SessionKeyID = int(value)
        except ValueError:
            self._Ipv6SessionKeyID = hex(int(value, 16))

    def _set_ipv6sessionid_with_str(self, value):
        self._Ipv6SessionID = value
