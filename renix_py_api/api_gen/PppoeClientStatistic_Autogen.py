...
@rom_manager.rom
class PppoeClientStatistic(Result):
    def __init__(self, **kwargs):
        self._PppoeClientBlockId = ''  # PPPoE Client Block Name, not editable
        self._PppoeClientId = 0  # PPPoE Client Index, not editable
        ...
        self._Ipv6GlobalAddress = ''  # IPv6 Global Address, not editable
        ...
        super(PppoeClientStatistic, self).__init__(**properties)
    ...
    @property
    def PppoeClientId(self):
        """
        get the value of property _PppoeClientId
        """
        if self.force_auto_sync:
            self.get('PppoeClientId')
        return self._PppoeClientId
    ...
    @property
    def Ipv6GlobalAddress(self):
        """
        get the value of property _Ipv6GlobalAddress
        """
        if self.force_auto_sync:
            self.get('Ipv6GlobalAddress')
        return self._Ipv6GlobalAddress
    ...
    def _set_pppoeclientid_with_str(self, value):
        try:
            self._PppoeClientId = int(value)
        except ValueError:
            self._PppoeClientId = hex(int(value, 16))
    ...
    def _set_ipv6globaladdress_with_str(self, value):
        self._Ipv6GlobalAddress = value
