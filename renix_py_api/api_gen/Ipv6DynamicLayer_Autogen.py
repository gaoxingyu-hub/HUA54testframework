...
@rom_manager.rom
class Ipv6DynamicLayer(DynamicNetworkLayer):
    def __init__(self, Address=None, Step=None, AddressList=None, PrefixLength=None, Gateway=None, GatewayStep=None, GatewayList=None, GatewayCount=None, **kwargs):
        ...
        super(Ipv6DynamicLayer, self).__init__(**properties)
    ...
    def edit(self, Address=None, Step=None, AddressList=None, PrefixLength=None, Gateway=None, GatewayStep=None, GatewayList=None, GatewayCount=None, **kwargs):
        properties = kwargs.copy()
        if Address is not None:
        ...
        super(Ipv6DynamicLayer, self).edit(**properties)
