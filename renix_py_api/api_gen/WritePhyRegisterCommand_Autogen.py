...
@rom_manager.rom
class WritePhyRegisterCommand(ROMCommand):
    def __init__(self, PortHandle=None, RegisterMode=None, Device=None, Address=None, RegisterValue=None, **kwargs):
        ...
        self._RegisterValue = RegisterValue  # Register Value
        ...
        if RegisterValue is not None:
            properties['RegisterValue'] = RegisterValue

        # call base class function, and it will send message to renix server to create a class.
        super(WritePhyRegisterCommand, self).__init__(**properties)
