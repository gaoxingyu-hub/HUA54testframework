...
@rom_manager.rom
class Dot1xWizardConfig(ProtocolWizardConfig):
    def __init__(self, AuthMode=None, Identity=None, Password=None, UseAuthenticatorMac=None, AuthenticatorMac=None, RetryCount=None, RetryTimeout=None, RetransmitCount=None, RetransmitTimeout=None, SupplicantCertificateName=None, CertificatePassword=None, InnerTunnelAuthMode=None, DuplicateUserInfoToInner=None, InnerIdentity=None, InnerPassword=None, EnableClientCertificate=None, **kwargs):
        self._AuthMode = AuthMode  # Method:
        ...
        super(Dot1xWizardConfig, self).__init__(**properties)
    ...
    def edit(self, AuthMode=None, Identity=None, Password=None, UseAuthenticatorMac=None, AuthenticatorMac=None, RetryCount=None, RetryTimeout=None, RetransmitCount=None, RetransmitTimeout=None, SupplicantCertificateName=None, CertificatePassword=None, InnerTunnelAuthMode=None, DuplicateUserInfoToInner=None, InnerIdentity=None, InnerPassword=None, EnableClientCertificate=None, **kwargs):
        properties = kwargs.copy()
        if AuthMode is not None:
        ...
        super(Dot1xWizardConfig, self).edit(**properties)
