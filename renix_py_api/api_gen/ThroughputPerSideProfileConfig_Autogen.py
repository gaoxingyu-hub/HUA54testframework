...
@rom_manager.rom
class ThroughputPerSideProfileConfig(SearchLoadProfileConfig):
    def __init__(self, ProfileName=None, **kwargs):
        ...
        super(ThroughputPerSideProfileConfig, self).__init__(**properties)
    ...
    def edit(self, ProfileName=None, **kwargs):
        ...
        super(ThroughputPerSideProfileConfig, self).edit(**properties)
