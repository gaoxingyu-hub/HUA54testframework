...
@rom_manager.rom
class CaptureBytePattern(CapturePattern):
    def __init__(self, Data=None, Mask=None, Offset=None, **kwargs):
        ...
        super(CaptureBytePattern, self).__init__(**properties)
    ...
    def edit(self, Data=None, Mask=None, Offset=None, **kwargs):
        properties = kwargs.copy()
        if Data is not None:
            self._Data = Data
            properties['Data'] = Data
        ...
        super(CaptureBytePattern, self).edit(**properties)
