...
@rom_manager.rom
class StreamTemplateLoadProfile(ROMObject):
    def __init__(self, Rate=None, Unit=None, **kwargs):
        self._Rate = Rate  # Rate
        self._Unit = Unit  # Load Unit
        ...
        super(StreamTemplateLoadProfile, self).__init__(**properties)
    ...
    def edit(self, Rate=None, Unit=None, **kwargs):
        ...
        super(StreamTemplateLoadProfile, self).edit(**properties)
    ...
    def _set_unit_with_str(self, value):
        seperate = value.find(':')
        exec('self._Unit = EnumFrameLoadUnit.%s' % value[:seperate])
