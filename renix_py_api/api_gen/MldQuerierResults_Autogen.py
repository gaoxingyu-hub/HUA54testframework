...
@rom_manager.rom
class MldQuerierResults(Result):
    def __init__(self, **kwargs):
        ...
        self._QuerierRxChecksumErrors = 0  # Rx MLD Checksum Errors, not editable
        self._QuerierRxLengthErrors = 0  # Rx MLD Length Errors, not editable

        properties = kwargs.copy()

        # call base class function, and it will send message to renix server to create a class.
        super(MldQuerierResults, self).__init__(**properties)
