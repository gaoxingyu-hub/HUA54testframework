...
@rom_manager.rom
class ListSetMayInsertCommand(ROMCommand):
    def __init__(self, Stream=None, ParentName=None, **kwargs):
        ...
        self._MayInsertNode = None  # nodes that you can insert Current leaf, not editable
        ...
        super(ListSetMayInsertCommand, self).__init__(**properties)
    ...
    @property
    def MayInsertNode(self):
        """
        get the value of property _MayInsertNode
        """
        return self._MayInsertNode
    ...
    def _set_mayinsertnode_with_str(self, value):
        tmp_value = value.strip()
        if tmp_value.startswith('{'):
            tmp_value = tmp_value[1:-1]
        self._MayInsertNode = tmp_value.split()

    def _set_output_property(self, value):
        self._set_mayinsertnode_with_str(value)
