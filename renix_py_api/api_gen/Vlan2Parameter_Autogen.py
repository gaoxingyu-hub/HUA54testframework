...
@rom_manager.rom
class Vlan2Parameter(ROMObject):
    def __init__(self, VlanId=None, Priority=None, IsBound=None, **kwargs):
        self._VlanId = VlanId  # VLAN 2
        self._Priority = Priority  # VLAN 2 Priority
        ...
        super(Vlan2Parameter, self).__init__(**properties)
    ...
    def edit(self, VlanId=None, Priority=None, IsBound=None, **kwargs):
        ...
        super(Vlan2Parameter, self).edit(**properties)
