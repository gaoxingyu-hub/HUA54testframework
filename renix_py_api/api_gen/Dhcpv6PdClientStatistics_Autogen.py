...
@rom_manager.rom
class Dhcpv6PdClientStatistics(Result):
    def __init__(self, **kwargs):
        self._Dhcpv6PdClientId = ''  # DHCPv6 PD Session Name, not editable
        self._IaidValue = 0  # IAID Value, not editable
        self._SessionIndex = 0  # Session Index, not editable
        self._MacAddr = ''  # MAC Address, not editable
        self._VlanId = 0  # VLAN ID, not editable
        self._LeaseRx = 0  # Lease Received (sec), not editable
        self._AddressType = 'IA_NA'  # Address Type, not editable
        self._SessionState = ''  # Session State, not editable
        self._StateCode = 'OK'  # State Code, not editable
        ...
        super(Dhcpv6PdClientStatistics, self).__init__(**properties)
    ...
    @property
    def Dhcpv6PdClientId(self):
        """
        get the value of property _Dhcpv6PdClientId
        """
        if self.force_auto_sync:
            self.get('Dhcpv6PdClientId')
        return self._Dhcpv6PdClientId
    ...
    def _set_dhcpv6pdclientid_with_str(self, value):
        self._Dhcpv6PdClientId = value
