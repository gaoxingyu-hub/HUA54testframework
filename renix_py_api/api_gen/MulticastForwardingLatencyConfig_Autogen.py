...
@rom_manager.rom
class MulticastForwardingLatencyConfig(Rfc3918Config):
    def __init__(self, TrafficLoadUnit=None, TrafficLoadMode=None, TrafficLoad=None, TrafficLoadStart=None, TrafficLoadStep=None, TrafficLoadEnd=None, TrafficLoadCustom=None, RandomMinLoad=None, RandomMaxLoad=None, McGroupCountMode=None, McGroupCount=None, RandomMinMcGroupCount=None, RandomMaxMcGroupCount=None, McGroupCountStart=None, McGroupCountStep=None, McGroupCountEnd=None, McGroupCountCustom=None, **kwargs):
        ...
        super(MulticastForwardingLatencyConfig, self).__init__(**properties)
    ...
    def edit(self, TrafficLoadUnit=None, TrafficLoadMode=None, TrafficLoad=None, TrafficLoadStart=None, TrafficLoadStep=None, TrafficLoadEnd=None, TrafficLoadCustom=None, RandomMinLoad=None, RandomMaxLoad=None, McGroupCountMode=None, McGroupCount=None, RandomMinMcGroupCount=None, RandomMaxMcGroupCount=None, McGroupCountStart=None, McGroupCountStep=None, McGroupCountEnd=None, McGroupCountCustom=None, **kwargs):
        properties = kwargs.copy()
        if TrafficLoadUnit is not None:
        ...
        super(MulticastForwardingLatencyConfig, self).edit(**properties)
