...
@rom_manager.rom
class Ospfv3NetworkLsaConfig(ROMObject):
    def __init__(self, AdvertisingRouterId=None, LinkStateId=None, Options=None, Age=None, SequenceNumber=None, Checksum=None, **kwargs):
        ...
        super(Ospfv3NetworkLsaConfig, self).__init__(**properties)
    ...
    def edit(self, AdvertisingRouterId=None, LinkStateId=None, Options=None, Age=None, SequenceNumber=None, Checksum=None, **kwargs):
        properties = kwargs.copy()
        if AdvertisingRouterId is not None:
        ...
        super(Ospfv3NetworkLsaConfig, self).edit(**properties)
