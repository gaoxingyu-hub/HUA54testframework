...
@rom_manager.rom
class PimRpMapConfig(ROMObject):
    def __init__(self, MulticastGroupAddr=None, RpAddr=None, RpPriority=None, RpHoldTime=None, **kwargs):
        self._MulticastGroupAddr = MulticastGroupAddr  # Multicast Group IPv4 Address
        ...
        super(PimRpMapConfig, self).__init__(**properties)
    ...
    def edit(self, MulticastGroupAddr=None, RpAddr=None, RpPriority=None, RpHoldTime=None, **kwargs):
        ...
        super(PimRpMapConfig, self).edit(**properties)
