...
@rom_manager.rom
class ErroredFrameFilteringWriteDbCommand(Rfc2889WriteDbCommandBurstSize):
    def __init__(self, CrcChecked=None, CrcErroredFrameSize=None, UnderSizedChecked=None, UnderSizedFrameSize=None, OverSizedChecked=None, OverSizedFrameSize=None, MaxLegalFrameSize=None, **kwargs):
        ...
        super(ErroredFrameFilteringWriteDbCommand, self).__init__(**properties)
