...
@rom_manager.rom
class PppoeServerStatistic(Result):
    def __init__(self, **kwargs):
        self._PppoeServerBlockId = ''  # PPPoE Server Block Name, not editable
        self._PppoeServerId = 0  # PPPoE Server Index, not editable
        self._IpcpState = 'None'  # IPCP State, not editable
        self._Ipv6cpState = 'None'  # IPv6CP State, not editable
        self._MacAddress = ''  # MAC Address, not editable
        self._PeerMacAddress = ''  # Peer MAC Address, not editable
        self._PppoeSessionId = '0000'  # PPPoE Session ID, not editable
        self._VlanId = ''  # VLAN ID, not editable
        self._InnerVlanId = ''  # Inner VLAN ID, not editable
        self._Ipv4Address = ''  # IPv4 Address, not editable
        self._PeerIpv4Address = ''  # Peer IPv4 Address, not editable
        self._Ipv6LinklocalAddress = ''  # IPv6 Link-Local Address, not editable
        self._PeerIpv6LinklocalAddress = ''  # Peer IPv6 Link-Local Address, not editable
        ...
        self._SetupTime = 0  # Setup Time (ms), not editable
        self._RxPadi = 0  # Rx PADI, not editable
        self._TxPado = 0  # Tx PADO, not editable
        self._RxPadr = 0  # Rx PADR, not editable
        self._TxPads = 0  # Tx PADS, not editable
        ...
        super(PppoeServerStatistic, self).__init__(**properties)
    ...
    @property
    def PppoeServerBlockId(self):
        """
        get the value of property _PppoeServerBlockId
        """
        if self.force_auto_sync:
            self.get('PppoeServerBlockId')
        return self._PppoeServerBlockId

    @property
    def PppoeServerId(self):
        """
        get the value of property _PppoeServerId
        """
        if self.force_auto_sync:
            self.get('PppoeServerId')
        return self._PppoeServerId
    ...
    @property
    def PeerMacAddress(self):
        """
        get the value of property _PeerMacAddress
        """
        if self.force_auto_sync:
            self.get('PeerMacAddress')
        return self._PeerMacAddress

    @property
    def PppoeSessionId(self):
        """
        get the value of property _PppoeSessionId
        """
        if self.force_auto_sync:
            self.get('PppoeSessionId')
        return self._PppoeSessionId
    ...
    def Ipv4Address(self):
        """
        get the value of property _Ipv4Address
        """
        if self.force_auto_sync:
            self.get('Ipv4Address')
        return self._Ipv4Address

    @property
    def PeerIpv4Address(self):
        """
        get the value of property _PeerIpv4Address
        """
        if self.force_auto_sync:
            self.get('PeerIpv4Address')
        return self._PeerIpv4Address

    @property
    def Ipv6LinklocalAddress(self):
        """
        get the value of property _Ipv6LinklocalAddress
        """
        if self.force_auto_sync:
            self.get('Ipv6LinklocalAddress')
        return self._Ipv6LinklocalAddress

    @property
    def PeerIpv6LinklocalAddress(self):
        """
        get the value of property _PeerIpv6LinklocalAddress
        """
        if self.force_auto_sync:
            self.get('PeerIpv6LinklocalAddress')
        return self._PeerIpv6LinklocalAddress
    ...
    def SetupTime(self):
        """
        get the value of property _SetupTime
        """
        if self.force_auto_sync:
            self.get('SetupTime')
    ...
    def RxPadi(self):
        """
        get the value of property _RxPadi
        """
        if self.force_auto_sync:
            self.get('RxPadi')
        return self._RxPadi
    ...
    def TxPado(self):
        """
        get the value of property _TxPado
        """
        if self.force_auto_sync:
            self.get('TxPado')
        return self._TxPado
    ...
    def RxPadr(self):
        """
        get the value of property _RxPadr
        """
        if self.force_auto_sync:
            self.get('RxPadr')
        return self._RxPadr
    ...
    def TxPads(self):
        """
        get the value of property _TxPads
        """
        if self.force_auto_sync:
            self.get('TxPads')
        return self._TxPads
    ...
    def _set_pppoeserverblockid_with_str(self, value):
        self._PppoeServerBlockId = value

    def _set_pppoeserverid_with_str(self, value):
        try:
            self._PppoeServerId = int(value)
        except ValueError:
            self._PppoeServerId = hex(int(value, 16))
    ...
    def _set_peermacaddress_with_str(self, value):
        self._PeerMacAddress = value

    def _set_pppoesessionid_with_str(self, value):
        self._PppoeSessionId = value

    def _set_vlanid_with_str(self, value):
        self._VlanId = value

    def _set_innervlanid_with_str(self, value):
        self._InnerVlanId = value

    def _set_ipv4address_with_str(self, value):
        self._Ipv4Address = value

    def _set_peeripv4address_with_str(self, value):
        self._PeerIpv4Address = value

    def _set_ipv6linklocaladdress_with_str(self, value):
        self._Ipv6LinklocalAddress = value

    def _set_peeripv6linklocaladdress_with_str(self, value):
        self._PeerIpv6LinklocalAddress = value
    ...
    def _set_setuptime_with_str(self, value):
        try:
            self._SetupTime = int(value)
        except ValueError:
            self._SetupTime = hex(int(value, 16))

    def _set_rxpadi_with_str(self, value):
        try:
            self._RxPadi = int(value)
        except ValueError:
            self._RxPadi = hex(int(value, 16))

    def _set_txpado_with_str(self, value):
        try:
            self._TxPado = int(value)
        except ValueError:
            self._TxPado = hex(int(value, 16))

    def _set_rxpadr_with_str(self, value):
        try:
            self._RxPadr = int(value)
        except ValueError:
            self._RxPadr = hex(int(value, 16))

    def _set_txpads_with_str(self, value):
        try:
            self._TxPads = int(value)
        except ValueError:
            self._TxPads = hex(int(value, 16))
